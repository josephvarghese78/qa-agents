...
class CopilotAssistant:
    ...
    async def ask1(self, prompt, attachments=None):
    ...
    async def ask(self, prompt, attachments=None):
        ...
        async with CopilotClient() as client:
            ...
            async with await client.create_session(**self.session_args) as session:
                ...
                await done.wait()
        print(f"Agent {self.agent} completed.")
        return "".join(response_content), "".join(session_log)
